    ...
    <>
      <div className="grid-overflower">
        <div className="grid-holder">
          <div className="grid" data-masonry='{ "itemSelector": ".grid-item", "columnWidth": 400 }'>
            ...
            {
              plainQuotes.map((quote, i) => <PlainQuote words={quote.words} attribution={quote.attribution} key={i} />)
            }
